...
/* 승인된 재직증명서 발급 */
 function printWorkInfoReport(){
      ...
      if(data.approvalStatus=="승인"){
         ...
         window.open(
                 "${pageContext.request.contextPath}/systemmgmt/empreport?empCode="
  ...
  function sendEmail(){
     ...
     if(data==null){ alert("재직증명서를선택해주세요");
    }else if(eMail=="") {alert("이메일을입력해주세요");
    }else{
    ...
    $.ajax({
        url : "${pageContext.request.contextPath }/systemmgmt/email",
        data:{
           "empCode":empCode,
           "usage":usage,
...
<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
	...
	<div class="tab-pane fade" id="employmentList_tab" role="tabpanel"
		...
		<br /> <input type="button" class="ui-button ui-widget ui-corner-all"
			...
			class="ui-button ui-widget ui-corner-all" id="print_certificate"
			value="재직증명서 발급"> <input type=text
			class="ui-button ui-widget ui-corner-all" id="email_id"
			placeholder="이메일을입력해주세요"> <input type="button"
