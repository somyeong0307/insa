...
<body>
	...
	<div class="container">
		<nav>
			<div class="nav nav-tabs" id="nav-tab" role="tablist">
				<a class="nav-item nav-link active" data-toggle="tab" href="#overworkAttd_tab" role="tab" aria-controls="nav-home" aria-selected="true">초과근무 신청</a> 
				<a class="nav-item nav-link" data-toggle="tab" href="#overworkSerach_tab" role="tab" aria-controls="nav-profile" aria-selected="false">초과근무 조회</a>
			</div>
		</nav>
	</div>
	...
	<div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
		<div class="tab-pane fade show active" id="overworkAttd_tab" role="tabpanel" aria-labelledby="nav-home-tab">
			<font>초과근무 구분 </font><input id="selectOverwork"	class="ui-button ui-widget ui-corner-all" value="초과근무" readonly> 
			...
			<table style="margin : auto;">
				...
				<tr>
					...
					<td><input id="overwork_startT" class="ui-button ui-widget ui-corner-all" name="timePicker1" value= "19:00" readonly></td>
		...
		<div class="tab-pane fade" id="overworkSerach_tab" role="tabpanel" aria-labelledby="nav-profile-tab" style="width:1050px;">
		<table style="margin : auto;">
