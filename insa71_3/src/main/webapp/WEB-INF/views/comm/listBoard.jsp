...
<script type="text/javascript">
	...
	function makePage(){
		var html="";
		if(board.previous){
			html += "<a href=${pageContext.request.contextPath}/comm/listBoard/view?pn="+(board.pagenum-1)+">&lt &lt </a>&nbsp&nbsp"
		}
		for(var num=board.startpage; num<(board.endpage)+1 ; num++){
			html += "<a href=${pageContext.request.contextPath}/comm/listBoard/view?pn="+num+">"+num+"</a>&nbsp&nbsp";
		}
		if(board.next){
			html += "<a href=${pageContext.request.contextPath}/comm/listBoard/view?pn="+(board.pagenum+1)+">&gt&gt</a>"
		}
		$("#page").empty();
		$("#page").append(html);
	}
